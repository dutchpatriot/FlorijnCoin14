...
void Shutdown()
{
    ...
    RenameThread("florijncoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/florijncoin-project/florijncoin>";
    const std::string URL_WEBSITE = "<https://florijncoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("florijncoin-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Florijncoin version %s\n", FormatFullVersion());
}
