...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s florijncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  florijncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded florijncoin transaction") + "\n" +
              "  florijncoin-tx [options] -create [commands]   " + _("Create hex-encoded florijncoin transaction") + "\n" +
              "\n";
